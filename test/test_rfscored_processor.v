...
Definition test_rfscored_processor_inner {var} := @fn.Fn var _ _ (fun p => quartz_eexpr:(
  ...
  let st_written := $(expr.Call (@rf_write var) (expr.Binop binop.MkPair (expr.Var st) (expr.Binop binop.MkPair (expr.Var idx) (expr.Const (t:=type.Bits 8) (bits.of_Z _ 42))))) in
