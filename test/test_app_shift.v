...
Definition test_app_shift_inner {var} := @fn.Fn var type.Unit (Bits 4) (fun _ =>
  eexpr.Ret (expr.Binop binop.Sru (expr.Binop binop.App (expr.Const (t:=Bits 2) (bits.of_Z _ 3)) (expr.Const (t:=Bits 2) (bits.of_Z _ 3))) (expr.Const (t:=Bits 4) (bits.of_Z _ 1)))
).
