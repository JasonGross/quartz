...
Definition test_srs_lt_inner {var} := @fn.Fn var type.Unit (Bool) (fun _ =>
  eexpr.Ret (expr.Binop (binop.Compare true binop.cLt) (expr.Binop binop.Srs (expr.Const (t:=Bits 4) (bits.of_Z _ 8)) (expr.Const (t:=Bits 4) (bits.of_Z _ 1))) (expr.Const (t:=Bits 4) (bits.of_Z _ 0)))
).
